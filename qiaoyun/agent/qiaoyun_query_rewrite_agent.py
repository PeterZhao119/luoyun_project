...
class QiaoyunQueryRewriteAgent(DouBaoLLMAgent):
    ...
    default_output_schema = {
        ...
        "properties": {
            ...
            "CharacterPhotoQueryQuestion": {
                "type": "string",
                "description": "你认为针对角色的手机相册需要进行的查询语句，不要为空。当她谈论自己的时候，她也会想查看一下自己的手机相册，看看有没有什么好分享的照片。"
            },
            "CharacterPhotoQueryKeywords": {
                "type": "string",
                "description": "你认为针对角色的手机相册需要进行的查询关键词，不要为空。当她谈论自己的时候，她也会想查看一下自己的手机相册，看看有没有什么好分享的照片。"
            }
        }
    }
...
if __name__ == "__main__":
    context = {}
    c = QiaoyunQueryRewriteAgent(context)
